...
class TestEnterRequests:
    ...
    def test_enter_requests(self, driver, num, with_del):
        ...
        page = EnterRequestDocumentPage(driver, link)
        page.open()
        page.fill_enter_reqests_fields(num, True, False)
        page.fill_enter_reqests_fields(num, False, False)
        page.fill_enter_reqests_fields(num, True, True)
        page.fill_enter_reqests_fields(num, False, True)
