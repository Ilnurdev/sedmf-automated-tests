...
class TestRegulation:
    @pytest.mark.parametrize("npa_number,regulation_type,chain_index,first", [
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_1, 1, True, marks=[
                     pytest.mark.dependency(name="1-1"), pytest.mark.reg_851, pytest.mark.reg_chain_1]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_4, 1, False, marks=[
                     pytest.mark.dependency(name="1-4", depends=["1-1"]), pytest.mark.reg_851, pytest.mark.reg_chain_1]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_7, 1, False, marks=[
                     pytest.mark.dependency(name="1-7", depends=["1-4"]), pytest.mark.reg_851, pytest.mark.reg_chain_1]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_14, 1, False, marks=[
                     pytest.mark.dependency(name="1-14", depends=["1-7"]), pytest.mark.reg_851, pytest.mark.reg_chain_1]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_22, 1, False, marks=[
                     pytest.mark.dependency(name="1-22", depends=["1-14"]), pytest.mark.reg_851, pytest.mark.reg_chain_1]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_23, 1, False, marks=[
                     pytest.mark.dependency(name="1-23", depends=["1-22"]), pytest.mark.reg_851, pytest.mark.reg_chain_1]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_24, 1, False, marks=[
                     pytest.mark.dependency(name="1-24", depends=["1-23"]), pytest.mark.reg_851, pytest.mark.reg_chain_1]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_28, 1, False, marks=[
                     pytest.mark.dependency(name="1-28", depends=["1-24"]), pytest.mark.reg_851, pytest.mark.reg_chain_1]),

        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_7, 2, True, marks=[
                     pytest.mark.dependency(name="2-7"), pytest.mark.reg_851, pytest.mark.reg_chain_2]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_14, 2, False, marks=[
                     pytest.mark.dependency(name="2-14", depends=["2-7"]), pytest.mark.reg_851, pytest.mark.reg_chain_2]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_22, 2, False, marks=[
                     pytest.mark.dependency(name="2-22", depends=["2-14"]), pytest.mark.reg_851, pytest.mark.reg_chain_2]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_23, 2, False, marks=[
                     pytest.mark.dependency(name="2-23", depends=["2-22"]), pytest.mark.reg_851, pytest.mark.reg_chain_2]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_24, 2, False, marks=[
                     pytest.mark.dependency(name="2-24", depends=["2-23"]), pytest.mark.reg_851, pytest.mark.reg_chain_2]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_28, 2, False, marks=[
                     pytest.mark.dependency(name="2-28", depends=["2-24"]), pytest.mark.reg_851, pytest.mark.reg_chain_2]),

        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_1, 3, True, marks=[
                     pytest.mark.dependency(name="3-1"), pytest.mark.reg_851, pytest.mark.reg_chain_3]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_4, 3, False, marks=[
                     pytest.mark.dependency(name="3-4", depends=["3-1"]), pytest.mark.reg_851, pytest.mark.reg_chain_3]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_8, 3, False, marks=[
                     pytest.mark.dependency(name="3-8", depends=["3-4"]), pytest.mark.reg_851, pytest.mark.reg_chain_3]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_15, 3, False, marks=[
                     pytest.mark.dependency(name="3-15", depends=["3-8"]), pytest.mark.reg_851, pytest.mark.reg_chain_3]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_24, 3, False, marks=[
                     pytest.mark.dependency(name="3-24", depends=["3-15"]), pytest.mark.reg_851, pytest.mark.reg_chain_3]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_28, 3, False, marks=[
                     pytest.mark.dependency(name="3-28", depends=["3-24"]), pytest.mark.reg_851, pytest.mark.reg_chain_3]),

        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_8, 4, True, marks=[
                     pytest.mark.dependency(name="4-8"), pytest.mark.reg_851, pytest.mark.reg_chain_4]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_15, 4, False, marks=[
                     pytest.mark.dependency(name="4-15", depends=["4-8"]), pytest.mark.reg_851, pytest.mark.reg_chain_4]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_24, 4, False, marks=[
                     pytest.mark.dependency(name="4-24", depends=["4-15"]), pytest.mark.reg_851, pytest.mark.reg_chain_4]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_28, 4, False, marks=[
                     pytest.mark.dependency(name="4-28", depends=["4-24"]), pytest.mark.reg_851, pytest.mark.reg_chain_4]),

        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_9, 5, True, marks=[
                     pytest.mark.dependency(name="5-22"), pytest.mark.reg_851, pytest.mark.reg_chain_5]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_23, 5, False, marks=[
                     pytest.mark.dependency(name="5-23", depends=["5-22"]), pytest.mark.reg_851, pytest.mark.reg_chain_5]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_24, 5, False, marks=[
                     pytest.mark.dependency(name="5-24", depends=["5-23"]), pytest.mark.reg_851, pytest.mark.reg_chain_5]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_28, 5, False, marks=[
                     pytest.mark.dependency(name="5-28", depends=["5-24"]), pytest.mark.reg_851, pytest.mark.reg_chain_5]),

        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_2, 6, True, marks=[
                     pytest.mark.dependency(name="6-2"), pytest.mark.reg_1318, pytest.mark.reg_chain_6]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_5, 6, False, marks=[
                     pytest.mark.dependency(name="6-5", depends=["6-2"]), pytest.mark.reg_1318, pytest.mark.reg_chain_6]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_10, 6, False, marks=[
                     pytest.mark.dependency(name="6-10", depends=["6-5"]), pytest.mark.reg_1318, pytest.mark.reg_chain_6]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_16, 6, False, marks=[
                     pytest.mark.dependency(name="6-16", depends=["6-10"]), pytest.mark.reg_1318, pytest.mark.reg_chain_6]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_20, 6, False, marks=[
                     pytest.mark.dependency(name="6-20", depends=["6-16"]), pytest.mark.reg_1318, pytest.mark.reg_chain_6]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_25, 6, False, marks=[
                     pytest.mark.dependency(name="6-25", depends=["6-20"]), pytest.mark.reg_1318, pytest.mark.reg_chain_6]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_29, 6, False, marks=[
                     pytest.mark.dependency(name="6-29", depends=["6-25"]), pytest.mark.reg_1318, pytest.mark.reg_chain_6]),

        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_10, 7, True, marks=[
                     pytest.mark.dependency(name="7-10"), pytest.mark.reg_1318, pytest.mark.reg_chain_7]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_16, 7, False, marks=[
                     pytest.mark.dependency(name="7-16", depends=["7-10"]), pytest.mark.reg_1318, pytest.mark.reg_chain_7]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_20, 7, False, marks=[
                     pytest.mark.dependency(name="7-20", depends=["7-16"]), pytest.mark.reg_1318, pytest.mark.reg_chain_7]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_25, 7, False, marks=[
                     pytest.mark.dependency(name="7-25", depends=["7-20"]), pytest.mark.reg_1318, pytest.mark.reg_chain_7]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_29, 7, False, marks=[
                     pytest.mark.dependency(name="7-29", depends=["7-25"]), pytest.mark.reg_1318, pytest.mark.reg_chain_7]),

        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_11, 8, True, marks=[
                     pytest.mark.dependency(name="8-11"), pytest.mark.reg_1318, pytest.mark.reg_chain_8]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_17, 8, False, marks=[
                     pytest.mark.dependency(name="8-17", depends=["8-11"]), pytest.mark.reg_1318, pytest.mark.reg_chain_8]),
        pytest.param(RegulationFields.NPA_1318, RegulationFields.REGULATION_TYPE_1318_21, 8, False, marks=[
                     pytest.mark.dependency(name="8-21", depends=["8-17"]), pytest.mark.reg_1318, pytest.mark.reg_chain_8]),

        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_3, 9, True, marks=[
                     pytest.mark.dependency(name="9-3"), pytest.mark.reg_373, pytest.mark.reg_chain_9]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_6, 9, False, marks=[
                     pytest.mark.dependency(name="9-6", depends=["9-3"]), pytest.mark.reg_373, pytest.mark.reg_chain_9]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_12, 9, False, marks=[
                     pytest.mark.dependency(name="9-12", depends=["9-6"]), pytest.mark.reg_373, pytest.mark.reg_chain_9]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_18, 9, False, marks=[
                     pytest.mark.dependency(name="9-18", depends=["9-12"]), pytest.mark.reg_373, pytest.mark.reg_chain_9]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_22, 9, False, marks=[
                     pytest.mark.dependency(name="9-22", depends=["9-18"]), pytest.mark.reg_373, pytest.mark.reg_chain_9]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_23, 9, False, marks=[
                     pytest.mark.dependency(name="9-23", depends=["9-22"]), pytest.mark.reg_373, pytest.mark.reg_chain_9]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_26, 9, False, marks=[
                     pytest.mark.dependency(name="9-26", depends=["9-23"]), pytest.mark.reg_373, pytest.mark.reg_chain_9]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_30, 9, False, marks=[
                     pytest.mark.dependency(name="9-30", depends=["9-26"]), pytest.mark.reg_373, pytest.mark.reg_chain_9]),

        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_12, 10, True, marks=[
                     pytest.mark.dependency(name="10-12"), pytest.mark.reg_373, pytest.mark.reg_chain_10]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_18, 10, False, marks=[
                     pytest.mark.dependency(name="10-18", depends=["10-12"]), pytest.mark.reg_373, pytest.mark.reg_chain_10]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_22, 10, False, marks=[
                     pytest.mark.dependency(name="10-22", depends=["10-18"]), pytest.mark.reg_373, pytest.mark.reg_chain_10]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_23, 10, False, marks=[
                     pytest.mark.dependency(name="10-23", depends=["10-22"]), pytest.mark.reg_373, pytest.mark.reg_chain_10]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_26, 10, False, marks=[
                     pytest.mark.dependency(name="10-26", depends=["10-23"]), pytest.mark.reg_373, pytest.mark.reg_chain_10]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_30, 10, False, marks=[
                     pytest.mark.dependency(name="10-30", depends=["10-26"]), pytest.mark.reg_373, pytest.mark.reg_chain_10]),

        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_3, 11, True, marks=[
                     pytest.mark.dependency(name="11-3"), pytest.mark.reg_373, pytest.mark.reg_chain_11]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_6, 11, False, marks=[
                     pytest.mark.dependency(name="11-6", depends=["11-3"]), pytest.mark.reg_373, pytest.mark.reg_chain_11]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_13, 11, False, marks=[
                     pytest.mark.dependency(name="11-13", depends=["11-6"]), pytest.mark.reg_373, pytest.mark.reg_chain_11]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_19, 11, False, marks=[
                     pytest.mark.dependency(name="11-19", depends=["11-13"]), pytest.mark.reg_373, pytest.mark.reg_chain_11]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_26, 11, False, marks=[
                     pytest.mark.dependency(name="11-26", depends=["11-19"]), pytest.mark.reg_373, pytest.mark.reg_chain_11]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_30, 11, False, marks=[
                     pytest.mark.dependency(name="11-30", depends=["11-26"]), pytest.mark.reg_373, pytest.mark.reg_chain_11]),

        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_13, 12, True, marks=[
                     pytest.mark.dependency(name="12-13"), pytest.mark.reg_373, pytest.mark.reg_chain_12]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_19, 12, False, marks=[
                     pytest.mark.dependency(name="12-19", depends=["12-13"]), pytest.mark.reg_373, pytest.mark.reg_chain_12]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_26, 12, False, marks=[
                     pytest.mark.dependency(name="12-26", depends=["12-19"]), pytest.mark.reg_373, pytest.mark.reg_chain_12]),
        pytest.param(RegulationFields.NPA_373, RegulationFields.REGULATION_TYPE_373_30, 12, False, marks=[
                     pytest.mark.dependency(name="12-30", depends=["12-26"]), pytest.mark.reg_373, pytest.mark.reg_chain_12]),

        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_22, 13, True, marks=[
                     pytest.mark.dependency(name="13-22"), pytest.mark.reg_96]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_23, 13, False, marks=[
                     pytest.mark.dependency(name="13-23", depends=["13-22"]), pytest.mark.reg_96]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_27, 13, False, marks=[
                     pytest.mark.dependency(name="13-27", depends=["13-23"]), pytest.mark.reg_96]),
        pytest.param(RegulationFields.NPA_96, RegulationFields.REGULATION_TYPE_96_31, 13, False, marks=[
                     pytest.mark.dependency(name="13-31", depends=["13-27"]), pytest.mark.reg_96]),

        pytest.param(RegulationFields.NPA_83, RegulationFields.REGULATION_TYPE_83_32, 14, True, marks=[
                     pytest.mark.dependency(name="14-32"), pytest.mark.reg_83]),
        pytest.param(RegulationFields.NPA_83, RegulationFields.REGULATION_TYPE_83_33, 14, False, marks=[
                     pytest.mark.dependency(name="14-33", depends=["14-32"]), pytest.mark.reg_83]),
        pytest.param(RegulationFields.NPA_83, RegulationFields.REGULATION_TYPE_83_34, 14, False, marks=[
...
class TestRegulationRefuse:
    ...
    def test_regulation_refuse_1_1_doc(self, driver):
        ...
        page.regulation_doc(RegulationFields.NPA_851,
                            RegulationFields.REGULATION_TYPE_851_1, 1, False, True)
        page.create_and_send_agree_sheet()
        doc_id = page.save_document_id()
    ...
    def test_regulation_refuse_2_1_doc(self, driver):
        ...
        page.create_and_send_answer(page.modify_npa_type(
            RegulationFields.REGULATION_TYPE_851_1, 1), 1, True)
    ...
    def test_regulation_refuse_2_2_doc(self, driver):
        ...
        page.open()
        page.regulation_doc(RegulationFields.NPA_851,
                            RegulationFields.REGULATION_TYPE_851_4, 1, False, False)
        page.create_and_send_agree_sheet()
        doc_id = page.save_document_id()
    ...
    @pytest.mark.parametrize("npa_number,regulation_type,chain_index,first", [
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_1,
                     1, True, marks=[pytest.mark.dependency(name="refuse-1-1")]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_4, 1, False, marks=[
    ...
    def test_regulation_refuse_3_2_doc(self, driver):
        ...
        page.open()
        page.regulation_doc(RegulationFields.NPA_851,
                            RegulationFields.REGULATION_TYPE_851_7, 1, False, False)
        page.create_and_send_agree_sheet()
        doc_id = page.save_document_id()
...
class TestRegulationChainShowInstrument:
    ...
    def test_chain_show_index_22(self, driver):
        ...
        page.open()
        page.regulation_doc(RegulationFields.NPA_96,
                            RegulationFields.REGULATION_TYPE_96_22, 13, False, True, False)

        page.check_rcsi(
            False, 1, 1, RegulationFields.REGULATION_TYPE_96_22, False, False, 1)
        ...
        page.check_rcsi(
            False, 2, 1, RegulationFields.REGULATION_TYPE_96_22, True, False, 1)

        page.approve_agree_sheet_button()
        page.click_to_agree_button_on_agreement_window()

        page.check_rcsi(
            False, 3, 1, RegulationFields.REGULATION_TYPE_96_22, False, False, 1)
        ...
        page.check_rcsi(
            False, 4, 1, RegulationFields.REGULATION_TYPE_96_22, False, False, 1)

        page.create_answer(page.modify_npa_type(
            RegulationFields.REGULATION_TYPE_96_22, 1), True, 13)

        page.check_rcsi(
            False, 5, 1, RegulationFields.REGULATION_TYPE_96_22, False, False, 1)
        ...
        page.check_rcsi(
            False, 6, 1, RegulationFields.REGULATION_TYPE_96_22, True, False, 1)

        page.approve_agree_sheet_button()
        page.click_to_agree_button_on_agreement_window()

        page.check_rcsi(
            False, 7, 1, RegulationFields.REGULATION_TYPE_96_22, False, False, 1)
        ...
        page.check_rcsi(True, 8, 1, RegulationFields.REGULATION_TYPE_96_22,
                        False, False, 1, RegulationFields.REGULATION_TYPE_96_23)
    ...
    def test_chain_show_index_23(self, driver):
        ...
        page.regulation_doc(RegulationFields.NPA_96,
                            RegulationFields.REGULATION_TYPE_96_23, 13, False, False, True)

        page.check_rcsi(
            True, 1, 2, RegulationFields.REGULATION_TYPE_96_23, False, False, 2)
        ...
        page.check_rcsi(
            True, 2, 2, RegulationFields.REGULATION_TYPE_96_23, True, False, 2)

        page.approve_agree_sheet_button()
        page.click_to_agree_button_on_agreement_window()

        page.check_rcsi(
            True, 3, 2, RegulationFields.REGULATION_TYPE_96_23, False, False, 2)
        ...
        page.check_rcsi(True, 8, 2, RegulationFields.REGULATION_TYPE_96_23,
                        False, False, 2, RegulationFields.REGULATION_TYPE_96_27)
    ...
    def test_chain_show_repeat_22(self, driver):
        ...
        page.regulation_doc(RegulationFields.NPA_96,
                            RegulationFields.REGULATION_TYPE_96_22, 13, False, False, True)
        page.should_be_repeat_message()

        page.check_rcsi(
            True, 1, 3, RegulationFields.REGULATION_TYPE_96_22, False, True, 1)
        ...
        page.check_rcsi(
            True, 2, 3, RegulationFields.REGULATION_TYPE_96_22, True, False, 1)

        page.approve_agree_sheet_button()
        page.click_to_agree_button_on_agreement_window()

        page.check_rcsi(
            True, 3, 3, RegulationFields.REGULATION_TYPE_96_22, False, False, 1)
        ...
        page.check_rcsi(
            True, 4, 3, RegulationFields.REGULATION_TYPE_96_22, False, False, 1)

        page.create_answer(page.modify_npa_type(
            RegulationFields.REGULATION_TYPE_96_22, 1), False, 13)

        page.check_rcsi(
            True, 5, 3, RegulationFields.REGULATION_TYPE_96_22, False, False, 1)
        ...
        page.check_rcsi(
            True, 6, 3, RegulationFields.REGULATION_TYPE_96_22, True, False, 1)

        page.approve_agree_sheet_button()
        page.click_to_agree_button_on_agreement_window()

        page.check_rcsi(
            True, 7, 3, RegulationFields.REGULATION_TYPE_96_22, False, False, 1)

        page.register_and_send_enter_regulation_document(answer=True)
        page.agree_with_popup_window_enter_doc()
        TestRegulationChainShowInstrument.doc_id = page.save_document_id()

        page.check_rcsi(True, 8, 3, RegulationFields.REGULATION_TYPE_96_22,
                        False, False, 1, RegulationFields.REGULATION_TYPE_96_23)
    ...
    def test_chain_show_refuse_23(self, driver):
        ...
        page.check_rcsi(
            True, 1, 4, RegulationFields.REGULATION_TYPE_96_23, False, True, 2)
        ...
        page.check_rcsi(
            True, 2, 4, RegulationFields.REGULATION_TYPE_96_23, True, True, 2)

        page.approve_agree_sheet_button()
        page.click_to_agree_button_on_agreement_window()

        page.check_rcsi(
            True, 3, 4, RegulationFields.REGULATION_TYPE_96_23, False, True, 2)
        ...
        page.check_rcsi(True, 8, 4, RegulationFields.REGULATION_TYPE_96_23,
                        False, True, 2, RegulationFields.REGULATION_TYPE_96_27)

        page.create_refuse_document(
            False, TestRegulationChainShowInstrument.doc_id)

        page.check_rcsi(
            True, 9, 4, RegulationFields.REGULATION_TYPE_96_23, False, True, 2)
        ...
        page.check_rcsi(
            True, 10, 4, RegulationFields.REGULATION_TYPE_96_23, True, True, 2)

        page.approve_agree_sheet_button()
        page.click_to_agree_button_on_agreement_window()

        page.check_rcsi(
            True, 11, 4, RegulationFields.REGULATION_TYPE_96_23, False, True, 2)
        ...
        page.check_rcsi(True, 8, 4, RegulationFields.REGULATION_TYPE_96_23,
                        False, True, 3, RegulationFields.REGULATION_TYPE_96_23)
    ...
    def test_chain_show_after_refuse_23(self, driver):
        ...
        page.check_rcsi(
            True, 1, 4, RegulationFields.REGULATION_TYPE_96_23, False, True, 4)
        page.check_rcsi(
            True, 1, 4, RegulationFields.REGULATION_TYPE_96_23, False, True, 5)
        ...
        page.check_rcsi(
            True, 2, 4, RegulationFields.REGULATION_TYPE_96_23, True, False, 4)
        ...
        page.check_rcsi(
            True, 3, 4, RegulationFields.REGULATION_TYPE_96_23, False, False, 4)
        ...
        page.check_rcsi(True, 8, 4, RegulationFields.REGULATION_TYPE_96_23, False, False,
                        4, RegulationFields.REGULATION_TYPE_96_27, RegulationFields.REGULATION_TYPE_96_22)
    ...
    def test_chain_show_index_27(self, driver):
        ...
        page.regulation_doc(RegulationFields.NPA_96,
                            RegulationFields.REGULATION_TYPE_96_27, 13, False, False, True)

        page.check_rcsi(
            True, 1, 5, RegulationFields.REGULATION_TYPE_96_27, False, True, 2)
        ...
        page.check_rcsi(
            True, 2, 5, RegulationFields.REGULATION_TYPE_96_27, True, False, 2)
        ...
        page.check_rcsi(
            True, 3, 5, RegulationFields.REGULATION_TYPE_96_27, False, False, 2)
        ...
        page.check_rcsi(True, 8, 5, RegulationFields.REGULATION_TYPE_96_27, False, False,
                        2, RegulationFields.REGULATION_TYPE_96_31, RegulationFields.REGULATION_TYPE_96_22)
    ...
    def test_chain_show_index_31(self, driver):
        ...
        page.regulation_doc(RegulationFields.NPA_96,
                            RegulationFields.REGULATION_TYPE_96_31, 13, False, False, True)

        page.check_rcsi(
            True, 1, 6, RegulationFields.REGULATION_TYPE_96_31, False, True, 2)
        ...
        page.check_rcsi(
            True, 2, 6, RegulationFields.REGULATION_TYPE_96_31, True, False, 2)
        ...
        page.check_rcsi(
            True, 3, 6, RegulationFields.REGULATION_TYPE_96_31, False, False, 2)
        ...
        page.check_rcsi(
            True, 12, 6, RegulationFields.REGULATION_TYPE_96_31, False, False, 2)
...
class TestRegulationChainBreaking:
    ...
    def test_skip_request_2(self, driver):
        ...
        page.regulation_doc(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_7,
                            1, error=RegulationFields.REQUEST_PLACING_ERROR)
    ...
    def test_without_answer_1(self, driver):
        ...
        page.create_answer(page.have_answer(page.modify_npa_type(
            RegulationFields.REGULATION_TYPE_851_1, 1)), True, 1)
    ...
    def test_without_answer_2(self, driver):
        ...
        page.open()
        page.regulation_doc(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_7,
                            1, error=RegulationFields.CHAIN_NOT_FOUND_ERROR)
    ...
    @pytest.mark.parametrize("npa_number,regulation_type,chain_index,first", [
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_1,
                     1, True, marks=[pytest.mark.dependency(name="chain_break_4-1")]),
        pytest.param(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_4, 1, False, marks=[
    ...
    def test_not_repeat(self, driver, npa_number, regulation_type, chain_index, first):
        ...
        page.create_and_send_answer(page.modify_npa_type(
            regulation_type, 1), chain_index, first)
    ...
    def test_not_repeat_2(self, driver):
        ...
        page.regulation_doc(RegulationFields.NPA_851, RegulationFields.REGULATION_TYPE_851_4,
                            1, False, False, error=RegulationFields.REQUEST_PLACING_ERROR)
